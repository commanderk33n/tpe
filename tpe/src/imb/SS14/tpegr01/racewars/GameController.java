 ...
 * Rassen zu investieren, dadurch entsteht ein Squad pro Spieler. Die Armee aus
 * maximal zwei Rassen kämpfen im Folgenden gegeneinander. Der Spieler gewinnt,
 * der den gegnerischen Squad vernichtend schlägt.
 * 
 * Die Klasse <code>GameController</code> erstellt zwei Spieler und startet das
 * Spiel mit diesen.
 * 
 * 
 * @author Tim Hubert
...
public class GameController {
	...
	/**
	 * Startet das Spiel. Die zwei Spieler attackieren sich in Runden. Das
	 * Abbild der Kampfhandlung wird in der Klasse <code>GameViewer</code>
	 * dargestellt.
	 */
	...
	public void runGame() {
		...
		while (spieler1.lebendigeWesen > 0 && spieler2.lebendigeWesen > 0) {
			...
			if (istSpieler1AnDerReihe) {
				spieler2.wirdAngegriffen(spieler1, this.runde);
			} else {
				spieler1.wirdAngegriffen(spieler2, this.runde);
			}
	...
	public static void main(String[] args) {
		Spieler spieler1 = new Spieler("The walking Dead", "untote", 200);
		...
		Spieler spieler4 = new Spieler("Hipster-Horde", "menschen", 30,
				"menschen", 200);
		GameController gameONE = new GameController(spieler1, spieler4);
